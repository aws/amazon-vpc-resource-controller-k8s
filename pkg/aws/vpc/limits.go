...
// TODO: Store in a single map like EC2, Generate from Appropriate EC2 API Calls.
...
// TODO: Sync the values with ECS and EC2
// InstanceBranchENIsAvailable contains a mapping of instance types to the number of Branch ENIs available
var InstanceBranchENIsAvailable = map[string]int{
	"a1.medium":     10,
	"a1.large":      10,
	"a1.xlarge":     20,
	"a1.2xlarge":    40,
