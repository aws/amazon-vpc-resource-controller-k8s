...
// Source: pkg/provider/branch/trunk/trunk.go
...
func (m *MockTrunkENI) CreateAndAssociateBranchENIs(pod *v1.Pod, securityGroups []string, eniCount int, commitOwnership func([]*trunk.ENIDetails) error) ([]*trunk.ENIDetails, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateAndAssociateBranchENIs", pod, securityGroups, eniCount, commitOwnership)
...
func (mr *MockTrunkENIMockRecorder) CreateAndAssociateBranchENIs(pod, securityGroups, eniCount, commitOwnership interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateAndAssociateBranchENIs", reflect.TypeOf((*MockTrunkENI)(nil).CreateAndAssociateBranchENIs), pod, securityGroups, eniCount, commitOwnership)
}
...
func (m *MockTrunkENI) InitFromNodeNetworkState(trunkENIID string, pods []v1.Pod) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InitFromNodeNetworkState", trunkENIID, pods)
	ret0, _ := ret[0].(error)
	return ret0
}

// InitFromNodeNetworkState indicates an expected call of InitFromNodeNetworkState.
func (mr *MockTrunkENIMockRecorder) InitFromNodeNetworkState(trunkENIID, pods interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InitFromNodeNetworkState", reflect.TypeOf((*MockTrunkENI)(nil).InitFromNodeNetworkState), trunkENIID, pods)
}

// InitTrunk mocks base method.
func (m *MockTrunkENI) InitTrunk(instance ec2.EC2Instance, pods []v1.Pod) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InitTrunk", instance, pods)
	ret0, _ := ret[0].(error)
	return ret0
}

// InitTrunk indicates an expected call of InitTrunk.
func (mr *MockTrunkENIMockRecorder) InitTrunk(instance, pods interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InitTrunk", reflect.TypeOf((*MockTrunkENI)(nil).InitTrunk), instance, pods)
}
...
func (m *MockTrunkENI) PushBranchENIsToCoolDownQueue(UID string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "PushBranchENIsToCoolDownQueue", UID)
}

// PushBranchENIsToCoolDownQueue indicates an expected call of PushBranchENIsToCoolDownQueue.
func (mr *MockTrunkENIMockRecorder) PushBranchENIsToCoolDownQueue(UID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockTrunkENI) Reconcile(pods []v1.Pod) bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Reconcile", pods)
	ret0, _ := ret[0].(bool)
	return ret0
}

// Reconcile indicates an expected call of Reconcile.
func (mr *MockTrunkENIMockRecorder) Reconcile(pods interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Reconcile", reflect.TypeOf((*MockTrunkENI)(nil).Reconcile), pods)
}
