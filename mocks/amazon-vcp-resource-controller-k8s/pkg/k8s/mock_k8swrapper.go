...
// PatchCNINodeCheckpoint mocks base method.
func (m *MockK8sWrapper) PatchCNINodeCheckpoint(arg0 string, arg1 v1alpha10.NodeNetworkState, arg2 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PatchCNINodeCheckpoint", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}

// PatchCNINodeCheckpoint indicates an expected call of PatchCNINodeCheckpoint.
func (mr *MockK8sWrapperMockRecorder) PatchCNINodeCheckpoint(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PatchCNINodeCheckpoint", reflect.TypeOf((*MockK8sWrapper)(nil).PatchCNINodeCheckpoint), arg0, arg1, arg2)
}
