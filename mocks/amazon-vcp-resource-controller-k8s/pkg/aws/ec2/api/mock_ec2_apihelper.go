...
// GetSecurityGroupIdsForSecurityGroupNames mocks base method.
func (m *MockEC2APIHelper) GetSecurityGroupIdsForSecurityGroupNames(arg0 []string) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSecurityGroupIdsForSecurityGroupNames", arg0)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetSecurityGroupIdsForSecurityGroupNames indicates an expected call of GetSecurityGroupIdsForSecurityGroupNames.
func (mr *MockEC2APIHelperMockRecorder) GetSecurityGroupIdsForSecurityGroupNames(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSecurityGroupIdsForSecurityGroupNames", reflect.TypeOf((*MockEC2APIHelper)(nil).GetSecurityGroupIdsForSecurityGroupNames), arg0)
}
