...
// AssignIPv6PrefixAndWaitTillReady mocks base method.
func (m *MockEC2APIHelper) AssignIPv6PrefixAndWaitTillReady(arg0 string, arg1 int) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AssignIPv6PrefixAndWaitTillReady", arg0, arg1)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// AssignIPv6PrefixAndWaitTillReady indicates an expected call of AssignIPv6PrefixAndWaitTillReady.
func (mr *MockEC2APIHelperMockRecorder) AssignIPv6PrefixAndWaitTillReady(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AssignIPv6PrefixAndWaitTillReady", reflect.TypeOf((*MockEC2APIHelper)(nil).AssignIPv6PrefixAndWaitTillReady), arg0, arg1)
}
...
func (m *MockEC2APIHelper) CreateAndAttachNetworkInterface(arg0, arg1 *string, arg2 []string, arg3 []types.Tag, arg4 *int32, arg5, arg6 *string, arg7 *config.IPResourceCount, arg8 *types.ConnectionTrackingSpecificationRequest) (*types.NetworkInterface, error) {
	m.ctrl.T.Helper()
...
func (m *MockEC2APIHelper) CreateNetworkInterface(arg0, arg1 *string, arg2 []string, arg3 []types.Tag, arg4 *config.IPResourceCount, arg5 *string, arg6 *types.ConnectionTrackingSpecificationRequest) (*types.NetworkInterface, error) {
	m.ctrl.T.Helper()
...
func (mr *MockEC2APIHelperMockRecorder) DisassociateTrunkInterface(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DisassociateTrunkInterface", reflect.TypeOf((*MockEC2APIHelper)(nil).DisassociateTrunkInterface), arg0)
}
