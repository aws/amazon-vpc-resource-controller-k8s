...
// RestoreFromNodeNetworkState mocks base method.
func (m *MockEC2Instance) RestoreFromNodeNetworkState(arg0 v1alpha1.NodeNetworkState, arg1 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RestoreFromNodeNetworkState", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// RestoreFromNodeNetworkState indicates an expected call of RestoreFromNodeNetworkState.
func (mr *MockEC2InstanceMockRecorder) RestoreFromNodeNetworkState(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RestoreFromNodeNetworkState", reflect.TypeOf((*MockEC2Instance)(nil).RestoreFromNodeNetworkState), arg0, arg1)
}
