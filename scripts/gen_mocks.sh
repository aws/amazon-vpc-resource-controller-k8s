...
mockgen -destination=../mocks/amazon-vcp-resource-controller-k8s/pkg/aws/ec2/api/mock_sts.go github.com/aws/amazon-vpc-resource-controller-k8s/pkg/aws/ec2/api STSClient
...
# package pool mocks
mockgen -destination=../mocks/amazon-vcp-resource-controller-k8s/pkg/pool/mock_pool.go github.com/aws/amazon-vcp-resource-controller-k8s/pkg/pool Pool
